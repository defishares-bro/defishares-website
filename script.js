(function () {
  ...
  const translations = {
    en: {
      ...
      testAnnouncementMeta: "Test announcement · 2026-08-03",
      testAnnouncementTitle: "Test Announcement: Website Announcement Feature Is Live",
      testAnnouncementBody: "This is a test announcement for the DefiShares official website. The announcement section is ready for publishing project updates, network notices, and important user information.",
    ...
    zh: {
      ...
      projectNotices: "项目公告",
      testAnnouncementMeta: "测试公告 · 2026年8月3日",
      testAnnouncementTitle: "测试公告：官网公告发布功能已上线",
      testAnnouncementBody: "这是一条 DefiShares 官网测试公告，用于确认公告板块的展示效果。公告区域可用于发布项目进展、网络通知和重要用户信息。",
      projectBrief: "项目简报",

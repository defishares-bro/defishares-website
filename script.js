(function () {
  ...
  const translations = {
    en: {
      ...
      snapshotAnnouncementMeta: "Official announcement · 2026-08-03",
      snapshotAnnouncementTitle: "Asset Snapshot Announcement for the BitShares and New BitShares Blockchain Networks",
      snapshotAnnouncementBody: "DefiShares announces the snapshot schedule: snapshots of the relevant account and asset states on the BitShares blockchain network and the New BitShares blockchain network are scheduled to be generated at 00:00:00 on August 5, 2026 (UTC+0). In this announcement, a snapshot means a record of relevant account and asset states on the specified blockchain networks at the stated time. Eligibility, balance methodology, and any subsequent distribution or processing arrangements will be governed by the formal rules published by the project team, on-chain records, and subsequent official notices. Relevant users should verify their account status, asset balances, and network access in advance. Never submit private keys, seed phrases, or wallet passwords to unverified pages.",
      ...
      importantNotice: "Risk Warning",
      riskBody: "Digital assets can be volatile and may involve technical, market, liquidity, custody, and regulatory risks. DefiShares does not guarantee profit, price performance, redemption, or investment outcome. Users are responsible for safeguarding private keys and verifying official URLs before interacting with any wallet or airdrop page. DefiShares does not promise redemption between collateralized derivative digital assets and corresponding real-world assets.",
      language: "Language:",
    ...
    zh: {
      ...
      projectNotices: "项目公告",
      snapshotAnnouncementMeta: "正式公告 · 2026年8月3日",
      snapshotAnnouncementTitle: "BitShares 与 New BitShares 区块链网络资产快照公告",
      snapshotAnnouncementBody: "DefiShares 现公布资产快照安排：BitShares 区块链网络与 New BitShares 区块链网络的相关账户及资产状态快照，计划于 2026 年 8 月 5 日 00:00:00（UTC+0）生成。本公告所称“快照”，是指在指定时间点记录相关区块链网络上的账户及资产状态。具体纳入范围、余额认定方式，以及后续分配或处理安排，以项目方发布的正式规则、链上记录及后续官方公告为准。请相关用户提前核对账户状态、资产余额和网络连接，并谨防任何未经确认的页面索取私钥、助记词或钱包密码。",
      projectBrief: "项目简报",
      ...
      importantNotice: "风险警示",
      riskBody: "数字资产可能具有波动性，并涉及技术、市场、流动性、托管和监管风险。DefiShares 不保证收益、价格表现、兑付或投资结果。用户应自行保管私钥，并在与任何钱包或空投页面交互前核对官方 URL。DefiShares 不承诺抵押衍生数字资产与相应真实资产的承兑。",
      language: "语言：",

(function () {
  ...
  const translations = {
    en: {
      ...
      snapshotAnnouncementTitle: "BTS/NBS Official Snapshot Time Announcement",
      snapshotAnnouncementBody: "DefiShares announces that the official BTS/NBS snapshot will be generated on August 5, 2026 at 00:00:00 UTC+0. Relevant users should verify their account status, asset balances, and network access in advance. Subsequent distribution, claim, or processing arrangements will follow the official rules published by the project team. Never submit private keys, seed phrases, or wallet passwords to unverified pages.",
    ...
    zh: {
      ...
      snapshotAnnouncementTitle: "BTS/NBS 正式快照时间公告",
      snapshotAnnouncementBody: "DefiShares 现公布 BTS/NBS 正式快照时间：快照将于 2026 年 8 月 5 日 00:00:00（UTC+0）生成。请相关用户提前确认账户状态、资产余额及网络连接情况，并以官方公告和链上记录为准。快照完成后，后续分配、领取或处理安排将根据项目方发布的正式规则执行。请勿向任何未经确认的页面提交私钥、助记词或钱包密码。",
      projectBrief: "项目简报",

(function () {
  ...
  const translations = {
    en: {
      ...
      networkDesignationBody: "This site currently labels the active network as Mainnet Open. Confirm the chain ID and public WSS before connecting network tools.",
      ...
      chainParametersBody: "DFS, chain ID, address prefix, block interval, public RPC, and default market.",
    ...
    zh: {
      ...
      networkDesignationBody: "本站当前将活跃网络标记为主网开放。连接网络工具前，请核对链 ID 和公共 WSS。",
      riskStatement: "风险声明",
      ...
      chainParameters: "链参数",
      chainParametersBody: "DFS、链 ID、地址前缀、出块间隔、公共 RPC 和默认市场。",
  ...
  const configTranslations = {
    zh: {
      ...
      "Mainnet Open": dictionary.mainnetLiveStatus,
